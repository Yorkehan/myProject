...
import com.yorkehan.backstage.entity.custom.ArticleDetailVo;
import com.yorkehan.backstage.entity.custom.ArticleListVo;
import com.yorkehan.backstage.entity.custom.ArticleSearchVo;
...
public interface ArticleService {
	...
	//获得所有文章不分页
	default List<ArticleListVo> listArticle() throws Exception {
		return listArticle();
	}
